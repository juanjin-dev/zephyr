 ...
 * hardware has none. An offloading controller does both itself, so @p tx_crc
 * and @p rx_crc are ignored there and @p target selects the activated tag.
 *
 * @param tx_crc Append/expect the NFC-A CRC on TX/RX respectively.
 */
